-- SELECT sig_classe, dsc_classe nom_classe, DECODE(tip_categoria_classe, 'PO', 'ORIGINARIO', 'RECURSAL') tip_processo FROM judiciario.classe WHERE flg_ativo = 'S' AND flg_admite_meio_eletronico = 'S' AND flg_admite_peticionador_web = 'S';
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('ADI','AÇÃO DIRETA DE INCONSTITUCIONALIDADE','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('ACO','AÇÃO CÍVEL ORIGINÁRIA','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('HD','HABEAS DATA','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('MS','MANDADO DE SEGURANÇA','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('AO','AÇÃO ORIGINÁRIA','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('IF','INTERVENÇÃO FEDERAL','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('AR','AÇÃO RESCISÓRIA','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('SS','SUSPENSÃO DE SEGURANÇA','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('CC','CONFLITO DE COMPETÊNCIA','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('ADC','AÇÃO DECLARATÓRIA DE CONSTITUCIONALIDADE','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('AOE','AÇÃO ORIGINÁRIA ESPECIAL','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('AS','ARGÜIÇÃO DE SUSPEIÇÃO','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('ADPF','ARGÜIÇÃO DE DESCUMPRIMENTO DE PRECEITO FUNDAMENTAL','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('SL','SUSPENSÃO DE LIMINAR','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('Pet','PETIÇÃO','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('STA','SUSPENSÃO DE TUTELA ANTECIPADA','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('ADO','AÇÃO DIRETA DE INCONSTITUCIONALIDADE POR OMISSÃO','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('PSV','PROPOSTA DE SÚMULA VINCULANTE','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('AImp','ARGÜIÇÃO DE IMPEDIMENTO','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('EL','EXCEÇÃO DE LITISPENDÊNCIA','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('EI','EXCEÇÃO DE INCOMPETÊNCIA','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('HC','HABEAS CORPUS','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('Rcl','RECLAMAÇÃO','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('MI','MANDADO DE INJUNÇÃO','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('AC','AÇÃO CAUTELAR','ORIGINARIO');
Insert into PETICIONAMENTO.CLASSE_PETICIONAVEL (SIG_CLASSE,NOM_CLASSE,TIP_PROCESSO) values ('RvC','REVISÃO CRIMINAL','ORIGINARIO');
...
INSERT INTO peticionamento.peticao (seq_protocolo, sig_classe, num_peticao, num_ano, sig_peticionador, dat_peticionamento, tip_sigilo, tip_processo) VALUES (99999, 'ADI', 99999, 2016, 'USUARIO_FALSO', SYSDATE, 'PUBLICO', 'ORIGINARIO');
