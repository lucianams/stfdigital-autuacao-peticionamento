...
Insert into PETICIONAMENTO.ASSOCIADO (SEQ_ASSOCIADO, SEQ_PESSOA, NOM_PESSOA, TIP_ASSOCIADO, DSC_CARGO_FUNCAO, SEQ_PESSOA_ORGAO)
values (1, 18, 'Representante', 'REPRESENTANTE', 'Ministro Presidente', 12452180);