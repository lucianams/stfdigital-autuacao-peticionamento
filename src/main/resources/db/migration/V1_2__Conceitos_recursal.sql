...
alter table peticionamento.peticao add column tip_processo varchar2(10) not null;
alter table peticionamento.peticao add constraint ck_peti_tip_processo check (tip_processo in ('ORIGINARIO', 'RECURSAL'));

alter table peticionamento.classe_peticionavel add column tip_processo varchar2(10) not null;
