...
create table peticionamento.evento (seq_evento number not null, nom_evento varchar2(50) not null, dat_criacao date not null, bin_detalhe clob not null, tip_status smallint not null, constraint pk_evento primary key (seq_evento));
